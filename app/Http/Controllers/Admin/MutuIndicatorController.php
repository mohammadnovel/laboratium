...
use App\Http\Requests\MutuIndicatorRequest;
...
class MutuIndicatorController extends Controller
{
    ...
    public function __construct(MutuIndicator $repository, FormBuilder $formBuilder)
    {
        $this->module = 'mutu-indicator';
        $this->route = 'admin.mutu-indicator';
        $this->repository = $repository;
        $this->formBuilder = $formBuilder;
        $this->form = 'App\Forms\MutuIndicatorForm';
        $this->path = 'labs/MutuIndicator';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(MutuIndicatorRequest $request)
    {
        if (!$request->user()->can($this->module . '.create')) return notPermited();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(MutuIndicatorRequest $request, $id)
    {
        if (!$request->user()->can($this->module . '.update')) return notPermited();
