...
use App\Http\Requests\IndificationRequest;
use App\Models\Indification;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Str;

class IndificationController extends Controller
{
    private $module, $model, $form;
    protected $repository;
    use XIForm;

    public function __construct(Indification $repository, FormBuilder $formBuilder)
    {
        $this->module = 'indification';
        $this->route = 'admin.indification';
        $this->repository = $repository;
        $this->formBuilder = $formBuilder;
        $this->form = 'App\Forms\IndificationForm';
        $this->path = 'labs/Indification';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(IndificationRequest $request)
    {
        if (!$request->user()->can($this->module . '.create')) return notPermited();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(IndificationRequest $request, $id)
    {
        if (!$request->user()->can($this->module . '.update')) return notPermited();
