...
class ParameterController extends Controller
{
    ...
    public function __construct(Parameter $repository, FormBuilder $formBuilder)
    {
        $this->module = 'parameter';
        $this->route = 'admin.parameter';
        $this->repository = $repository;
        $this->formBuilder = $formBuilder;
        $this->form = 'App\Forms\ParameterForm';
        $this->path = 'labs/Parameter';
